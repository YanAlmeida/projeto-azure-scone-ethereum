...
restart_tee_containers() {
    run_tee_container
    run_untrusted_container $1
    run_nginix_container
}

run_test() {
    export BATCH_SIZE=$1

    locust -f main.py --headless -u $2 --host "http://127.0.0.1:8080/output_100kb.pdf" --run-time 5m
}
