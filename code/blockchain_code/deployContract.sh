...
ganache --server.host 0.0.0.0 --wallet.mnemonic "${MNEMONIC}" --wallet.hdPath "${DERIVATION_PATH}" --wallet.defaultBalance "${INITIAL_BALANCE}" -a 1000 --miner.blockTime 15 --miner.defaultGasPrice 0x1 --miner.blockGasLimit 0x3b9aca00 --miner.defaultTransactionGasLimit 0x3b9aca00 &
